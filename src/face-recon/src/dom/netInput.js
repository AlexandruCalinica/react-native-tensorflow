...
export class NetInput {
   ...
   * @param isCenterInputs (optional, default: false) If true, add an equal amount of padding on
  ...
  toBatchTensor(inputSize, isCenterInputs = true) {
    ...
    return tf.tidy(() => {
      ...
      return tf.stack(inputTensors.map(t => t.toFloat())).as4D(this.batchSize, inputSize, inputSize, 3);
    })
  }
}
