...
export class FaceMatcher {
  /**
   *
   * @param inputs - LabeledFaceDescriptors | WithFaceDescriptor<any> | Float32Array | Array<LabeledFaceDescriptors | WithFaceDescriptor<any> | Float32Array>
   ...
   * @param descriptors - Float32Array[]
   * @returns {number}
   */
